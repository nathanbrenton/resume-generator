module.exports = [
  ...
  },
  {
    ...
    requiredSkills: ["Python", "Docker", "Playwright", "pytest", "test automation"],
  ...
  },
  {
    ...
    requiredSkills: ["Python", "Docker", "ServiceNow", "Apache Tomcat", "production support"],
    requiredJobIds: ["2024-02-05_2026-03-27_roth-staffing-companies_system-engineer-i"],
    minExperienceBullets: 5,
    minProjectBullets: 2
  },
  {
    ...
    requiredSkills: ["Python", "Docker", "RHEL 9", "Oracle WebLogic", "Bash"],
    requiredJobIds: ["2024-02-05_2026-03-27_roth-staffing-companies_system-engineer-i"],
  ...
  },
  {
    ...
    requiredSkills: ["Python", "Docker", "Docker Compose", "deployment validation", "Bash"],
  ...
  },
  {
    ...
    requiredJobIds: ["2022-08-18_2024-01-03_randstad-technologies_jr-deskside-technician"],
    minExperienceBullets: 5,
    minProjectBullets: 1
  },
  {
  ...
  },
  {
    ...
    expectedFamily: "Cybersecurity / Security Quality / IAM",
    requiredSkills: ["Python", "Docker", "vulnerability remediation", "security validation", "Active Directory"],
    requiredJobIds: ["2024-02-05_2026-03-27_roth-staffing-companies_system-engineer-i"],
    minExperienceBullets: 4,
    minProjectBullets: 2
  },
  ...
  },
  {
    ...
    requiredSkills: ["Python", "Docker", "FFmpeg", "AviSynth", "transcoding"],
